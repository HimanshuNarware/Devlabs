...
const extensions = [
  ...
  { name: "Peacock Extension", description: "allows you to change the color of your Visual Studio Code environment, so you can quickly identify which instance you’ve just switched to.", link: "https://marketplace.visualstudio.com/items?itemName=johnpapa.vscode-peacock", image: "https://johnpapa.gallerycdn.vsassets.io/extensions/johnpapa/vscode-peacock/4.2.2/1663810940966/Microsoft.VisualStudio.Services.Icons.Default"},
]
