...
const tools = [
  ...
  { 
    name: "Foundation", 
    description: "Foundation is a free, open source framework that provides ready-to-use frontend components and CSS classes for direct use", 
  ...
  { 
    name: "LottieFiles", 
    description: "Largest collection of free-to-use animations, with thousands of unique designs that can be used for both personal and commercial projects.", 
