...
function Footer() {
    return ( <
        ...
        <
        a className = ""
        href = "https://www.devlabsstore.tech/" >
        Home <
        /a> <
        /li> <
        li className = "nav-item" >
        <
        a className = ""
        href = "https://www.devlabsstore.tech/about" >
        About Us <
        /a> <
        /li> <
        li className = "nav-item" >
        <
        a className = ""
        href = "https://www.devlabsstore.tech/bookmark" >
        Bookmark <
        /a> <
        /li> <
        li className = "nav-item" >
        ...
        <
        /a> <
        a href = 'https://twitter.com/N_Himanshu_/'
        rel = 'noreferrer'
        target = '_blank' >
        <
        ...
        <
        /a> <
        a href = "mailto:himanshunarware77@gmail.com"
        rel = "noreferrer" >
        <
