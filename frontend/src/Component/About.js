...
function About() {
  ...
  return (
    <div className="text-[#74A309] dark:text-[#8b5cf6]">
      <div className="container-one ">
        <div className="bx-1">
          ...
          <button className="repo-btn dark:bg-[#8b5cf6] dark:border-[#8b5cf6]">
            <a
      ...
      <div className="container-one">
        <div className="bx-1">
          <img
            className="img"
            src="https://imgs.search.brave.com/pQigBw5L8ODloy7loco05dRT56xI3iAmVRKPCUYYltc/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vaWQvOTYw/NTMxMDEyL3ZlY3Rv/ci9vcGVuLXNvdXJj/ZS1pY29uLmpwZz9z/PTYxMng2MTImdz0w/Jms9MjAmYz1SYUxi/UU1fMjA2bHNHcHRZ/WW1ZUG0zYk42SHVM/WFZlZWFtb3ozZXNL/S0VRPQ"
            alt="img"
          />
        </div>

        <div className="bx-2 my-2">
          <p className="dark:text-[#8b5cf6]">
          ...
          <button className="repo-btn dark:bg-[#8b5cf6] dark:border-[#8b5cf6] my-2">
            <a
      ...
      <div className="contributor-container">
        ...
        <div className="founder-container">
          <div className="content-box  dark:border-[#8b5cf6]">
            <img
            ...
            <div className="buttons-container">
              <button className="profile-btn  dark:bg-[#8b5cf6] dark:border-[#8b5cf6]">
        ...
        <div className="grid-container">
          {currentPageData?.map((contributor) => {
            return (
              <div
                className="content-box dark:border-[#8b5cf6]"
                key={contributor.id}
              >
                <img
                  className="logo img"
                  ...
                  alt="avatar"
                />
                <h3 className="text-xl">{contributor.login}</h3>
